...
class PostFragment : Fragment() {
    ...
    data class Post(val userId: Int, val id: Int, val title:
    ...
    Bundle?) {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            val post =
                makeHttpGetRequest("https://jsonplaceholder.typicode.com/posts/1")
            withContext(Dispatchers.Main) {
                if (post != null) {
                    binding.textUserId.text =
